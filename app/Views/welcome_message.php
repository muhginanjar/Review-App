...
<head>
    <meta charset="UTF-8">
    <title>Selamat Datang di Review App</title>
    <meta name="description" content="The small framework with powerful features">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="shortcut icon" type="image/png" href="img/koolawu-icon.png">
</head>
<body>
        ...
        <ul>
            <li class="logo">
                <a href="https://codeigniter.com" target="_blank">
                    <img src="img/Logo_primer.png" alt="Review App" style="height:100%;" />
                </a>
            </li>
